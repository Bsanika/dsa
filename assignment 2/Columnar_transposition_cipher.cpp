...
enter key: 321
Encrypted Message : l_eohl
Decrypted Message : hello*/

/*msg: The input plaintext message to be encrypted.
key: The keyword used to determine the order of rearrangement.
len_key: Length of the key.
len_msg: Length of the message.
col_val: Array to store the column ordering derived from the key.*/